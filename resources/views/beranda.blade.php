    ...
    {{-- <section id="ts-service-area" class="ts-service-area pb-0">
        <div class="container">
            ...
            <div class="row mt row-service">
                <div class="col-lg-4">
                    <div class="ts-service-box d-flex">
                        ...
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title"><a href="#">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing
                                    elit</a></h3>
                ...
                <div class="container-img-han col-lg-4 text-center">
                    <img loading="lazy" class="img-fluid" src="{{ asset('images/PRIMATECH/hanatas.svg') }}"
                        alt="Nurfauzan Hanif">
                </div><!-- Col end -->

                <div class="service-box col-lg-4 mt-30 mt-lg-0 mb-4 mb-lg-0">
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{ asset('Template') }}/images/icon-image/alat-medis.png"
                                width="56" height="50" alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title"><a href="#">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing

...
<div class="col-lg-8">
    <form method="POST" action="/dashboard/project" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="title_project" class="form-label">Title Foto</label>
            <input type="text" class="form-control @error('title_project') is-invalid @enderror" name="title_project" id="title_project" value="{{old('title_project')}}" autofocus>
            @error('title_project')
        ...
        <div class="mb-3 col-md-6">
            ...
            <select name="kategori_id" class="form-select">
                ...
                <option value="{{$kategori->id}}" selected>{{ $kategori->project_kategori }}</option>
                @else
...
<script>
    const title_galeri = document.querySelector("#title_project");

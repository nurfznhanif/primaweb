...
<div class="pagetitle">
    ...
    <div class="col">
        <a href="/dashboard/project/create" class="btn btn-primary text-white">Tambah Project<i class="bi bi-arrow-right-short"></i></a>
        <a href="/dashboard/project-kategori/create" class="btn btn-warning text-white">Tambah Kategori Project<i class="bi bi-arrow-right-short"></i></a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="align-middle">
                                <td><img src="{{ asset('images/project-image/'.$data->image) }}" alt="" width="200"></td>
                                ...
                                <td>
                                    ...
                                    <form action="/dashboard/project/{{$data->id}}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf

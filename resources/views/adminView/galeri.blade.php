...
<div class="pagetitle">
    ...
    <div class="col">
        <a href="/dashboard/galeri/create" class="btn btn-primary text-white">Tambah Foto <i
                class="bi bi-arrow-right-short"></i></a>
        <a href="/dashboard/galeri-kategori/create" class="btn btn-warning text-white">Tambah Kategori Foto<i
                class="bi bi-arrow-right-short"></i></a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle">
                                    <td><img src="{{ asset('images/galeri-image/' . $data->image) }}" alt=""
                                            width="200"></td>

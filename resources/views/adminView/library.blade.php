...
@section('content')
    <div class="pagetitle">
        ...
        <a href="/dashboard/e-library/folder/create" class="btn btn-primary text-white">Buat Folder <i
                class="bi bi-arrow-right-short"></i></a>

        <a href="/dashboard/e-library/create" class="btn btn-secondary text-white">Tambah Buku <i
                class="bi bi-arrow-right-short"></i></a>
    </div>
    <!-- End Page Title -->
                                ...
                                <tbody>
                                    @foreach ($books as $book)
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="/file/file-buku/{{ $book->file_buku }}"><button
                                                        class="btn btn-secondary" title="Download Buku"><i
                                                            class="bi bi-download"></i></button></a>
                                                <form action="/dashboard/e-library/{{ $book->id }}" method="POST"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf

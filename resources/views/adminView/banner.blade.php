...
@section('content')
    <div class="pagetitle">
        ...
        <div class="col">
            <a href="/dashboard/banner/create" class="btn btn-primary text-white">Tambah Banner <i
                                ...
                                <tbody>
                                    @foreach ($data as $banner)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/dashboard/banner/{{ $banner->id }}" class="btn btn-primary"
                                                    title="Detail"><i class="bi bi-eye"></i></a>
                                                <a href="/dashboard/banner/{{ $banner->id }}/edit" class="btn btn-warning"

                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">
                                            <img src="{{ asset('images/partner-image/' . $partner->image) }}"
                                                class="img-fluid" width="100" title="{{ $partner->nama_partner }}">
                                        </th>
                                        <th>
                                            <form action="/dashboard/partnership/{{ $partner->id }}" method="POST"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf

    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 mb-4">
            <div class="latest-post">
                ...
                <div class="post-body">
                    <h4 class="post-title">
                        <a href="/services/layanan-poliklinik" class="d-inline-block">UI / UX</a>
                    </h4>
                    <span>Donec non lobortis turpis. Etiam laoreet eros et justo sagittis, eget fermentum dolor lobortis. Proin dapibus enim eu tellus aliquam fermentum. Maecenas condimentum, purus quis dictum posuere, mi enim venenatis felis, eu semper metus orci vel nisl. Pellentesque ut metus eu purus feugiat gravida.</span>
                </div>
        ...
        <div class="col-lg-6 col-md-6 mb-4">
            <div class="latest-post">
                ...
                <div class="post-body">
                    <h4 class="post-title">
                        <a href="/services/fasilitas-layanan" class="d-inline-block">WEB DEV</a>
                    </h4>
        ...
        <div class="col-lg-6 col-md-6 mb-4">
            <div class="latest-post">
                ...
                <div class="post-body">
                    <h4 class="post-title">
                        <a href="/services/fasilitas-layanan" class="d-inline-block">DATA SCIENCE</a>
                    </h4>
